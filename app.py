...
USERS_DB = {
    'admin': hashlib.sha256('TooHotSummer2025'.encode()).hexdigest(),
    'user1': hashlib.sha256('TooHotSummer2025'.encode()).hexdigest(),
    'demo': hashlib.sha256('TooHotSummer2025'.encode()).hexdigest(),
    'michaeloleary': hashlib.sha256('TooHotSummer2025'.encode()).hexdigest(),
    'michaeloleary@michaelolearydotnet.onmicrosoft.com': hashlib.sha256('TooHotSummer2025'.encode()).hexdigest(),
    'MichaelOLeary@MichaelOLearyDotNet.onmicrosoft.com': hashlib.sha256('TooHotSummer2025'.encode()).hexdigest()
    }
...
<body>
    <div class="container">
        ...
        <div class="info">
            ...
            <ul>
                <li><strong>admin</strong> / TooHotSummer2025</li>
                <li><strong>user1</strong> / TooHotSummer2025</li>
                <li><strong>demo</strong> / TooHotSummer2025</li>
                <li><strong>michaeloleary</strong> / TooHotSummer2025</li>
                <li><strong>michaeloleary@michaelolearydotnet.onmicrosoft.com</strong> / TooHotSummer2025</li>
           </ul>
        </div>
